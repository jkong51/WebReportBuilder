                                ...
                                <div class="modal-header">
                                    ...
                                    <table class="table1">
                                        ...
                                        <tr>
                                            ...
                                            <td align="justify">
                                                <asp:CheckBoxList ID="ColumnCbList" Width="100%" CssClass="chkspacing" runat="server" Visible="false" OnSelectedIndexChanged="ColumnCbList_SelectedIndexChanged" AutoPostBack="true" RepeatLayout="flow" RepeatColumns="2" RepeatDirection="Vertical" >
                                                </asp:CheckBoxList>
                                            </td>
                                        </tr>
                                        <tr>
